...
class LiquidateOnchainLBTest(MainContractBaseTestCase):
        ...
        initial_storage = {
            ...
            'liquidity_book': {
                BOB_ADDRESS: {
                    ...
                    'gross_credit': 84_000_000_000_000,
                    'lb_shares': 100_000,
                },
                CLARE_ADDRESS: {
    ...
    def test_basic(self):
        ...
        self.assertEqual(self.main_contract.storage['total_gross_credit'](), 1_116_000_000_000_000)
        ...
        self.assertEqual(self.main_contract.storage['deposit_index'](), 1_502_267_180_500)
        ...
        self.assertEqual(self.main_contract.context.get_balance(), 168_668_722)
        self.assertAlmostEqual(self.alice_client.balance() - initial_admin_balance, Decimal(21.160_350), delta=TEST_GAS_DELTA)
        ...
        self.assertEqual(self.main_contract.storage['total_gross_credit'](), 916_000_000_000_000)
        self.assertEqual(self.main_contract.storage['total_net_credit'](), 1_090_000_000_000_000)
        self.assertEqual(self.main_contract.storage['totalSupply'](), 4_000_000_000_000_000)

        self.assertEqual(self.main_contract.storage['gross_credit_index'](), 1_900_000_000_000)
        self.assertEqual(self.main_contract.storage['net_credit_index'](), 1_600_000_000_000)
        self.assertEqual(self.main_contract.storage['deposit_index'](), 1_420_465_549_750)
        ...
        self.assertEqual(self.main_contract.context.get_balance(), 221_462_199)
        self.assertAlmostEqual(self.alice_client.balance() - initial_admin_balance, Decimal(0), delta=TEST_GAS_DELTA)
