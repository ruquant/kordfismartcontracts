...
class FA12Test(MainContractBaseTestCase):
    ...
    def test_common_operations(self):
        ...
        (self.main_contract.depositLending().with_amount(1000_000_000)
            .send(gas_reserve=10000, min_confirmations=1))
        (self.main_contract
            .getBalance(BOB_ADDRESS, f'{self.viewer.context.address}%target')
            .send(gas_reserve=10000, min_confirmations=1))
        self.assertEqual(self.viewer.storage(), 666_666_666_666_666)
        self.assertDictEqual(self.main_contract.storage['ledger'][BOB_ADDRESS](),
            {'balance': 666_666_666_666_666, 'approvals': {}})
        ...
        self.assertEqual(self.viewer.storage(), 150_000_000_000)
        self.assertDictEqual(self.main_contract.storage['ledger'][BOB_ADDRESS](),
            {'balance': 666_516_666_666_666, 'approvals': {}})
        self.assertDictEqual(self.main_contract.storage['ledger'][CLARE_ADDRESS](),
            {'balance': 150_000_000_000, 'approvals': {}})

        # Clare can withdraw deposit
        clare_initial_balance = self.clare_client.balance()
        ...
        self.assertAlmostEqual(self.clare_client.balance() - clare_initial_balance, Decimal('0.1'), delta=TEST_GAS_DELTA)
        self.assertDictEqual(self.main_contract.storage['ledger'][CLARE_ADDRESS](),
            {'balance': 83_333_333_333, 'approvals': {}})
        self.assertDictEqual(self.main_contract.storage['ledger'][BOB_ADDRESS](),
            {'balance': 666_516_666_666_666, 'approvals': {}})
        ...
        self.assertDictEqual(self.main_contract.storage['ledger'][CLARE_ADDRESS](),
            {'balance': 83_333_333_333, 'approvals': {}})
        self.assertDictEqual(self.main_contract.storage['ledger'][BOB_ADDRESS](),
            {'balance': 516_516_666_666_666, 'approvals': { CLARE_ADDRESS: 50_000_000_000_000}})
        self.assertDictEqual(self.main_contract.storage['ledger'][ALICE_ADDRESS](),
            {'balance': 150_000_000_000_000, 'approvals': {}})
